var EffecktPositionalModals = {
  ...
  bindUIActions: function() {
    ...
    jQuery(this.modalButtonClass).on( Effeckt.buttonPressedEvent, function(e) {
      e.preventDefault();
      self.openModal(jQuery(this));
    });

    jQuery(document).on( Effeckt.buttonPressedEvent, this.modalCloseButtonClass, function(e) {
      e.preventDefault();
  ...
  openModal: function($el) {
    ...
    var self = this,
        ...
        scrollTop = jQuery('.effeckt-page-active').scrollTop();
    ...
    var modal = this.createModal(jQuery("#effeckt-modal-wrap").html(), style, position);
    modal.show();
  ...
  add: function($el, modal) {
    ...
    jQuery('.effeckt-page-active').append(modal);
