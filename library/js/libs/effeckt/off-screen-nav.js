var EffecktOffScreenNav = {
  ...
  nav: jQuery("#effeckt-off-screen-nav"),
  closeButton: jQuery("#effeckt-off-screen-nav-close"),
  ...
  bindUIActions: function() {
    ...
    jQuery(".off-screen-nav-button, #effeckt-off-screen-nav-close").on( Effeckt.buttonPressedEvent, function() {
      self.toggleNav(this);
    });
  ...
  toggleNav: function(el) {
    ...
    if (!this.nav.hasClass("effeckt-show")) {
      ...
      if (this.threedee) {
        jQuery("body").addClass("effeckt-perspective");
      }
      ...
      this.nav.on( Effeckt.transitionAnimationEndEvent, function () {
        ...
        jQuery('[data-effeckt-page].effeckt-page-active, .effeckt-overlay').on( Effeckt.buttonPressedEvent, self.toggleNav.bind(self));
      });
    ...
    // Hide
      ...
      this.nav.on( Effeckt.transitionAnimationEndEvent, function () {
        ...
        jQuery('[data-effeckt-page].effeckt-page-active, .effeckt-overlay').off( Effeckt.buttonPressedEvent );
      });
  ...
  hideNav: function() {
    ...
    jQuery("body").removeClass("effeckt-perspective");
  },
  ...
  _hideCardDeckTop: function() {
    ...
    li.each(function(index){
      jQuery(this).css(Modernizr.prefixed('transform'), 'translateY(' + (index*2) + 'px)')
  ...
  _showCardDeckTop: function() {
    ...
    li.each(function(index){
      ...
      jQuery(this).css(Modernizr.prefixed('transform'), 'translateY(' + (index+1) * height + 'px)')
        .css("width" , '100%');
    });
  },
